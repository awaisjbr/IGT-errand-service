      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:mx-28 lg:gap-10">
          ...
          <div className="flex-1 hidden lg:block place-content-center">
            ...
            <ul className="ml-16">
              <li className="list-disc font-poppins text-md"><span className="font-bigShoulder font-bold text-md">Save Time:</span> Focus on what matters most while we handle the rest.</li>
              <li className="list-disc font-poppins text-md"><span className="font-bigShoulder font-bold text-md">Trusted Team:</span> Experienced and reliable errand experts.</li>
              <li className="list-disc font-poppins text-md"><span className="font-bigShoulder font-bold text-md">Convenient Services:</span> Tailored to meet your unique needs.</li>
              <li className="list-disc font-poppins text-md"><span className="font-bigShoulder font-bold text-md">Peace of Mind:</span> Know that your tasks are in safe hands.</li>
            </ul>
            <h3 className="font-bigShoulder text-xl font-bold mt-3">Our Promise</h3>
            <p className="font-poppins mt-1 text-justify text-md">We promise to treat every errand as if it were our own, ensuring prompt, professional, and friendly service every time. Your satisfaction is our top priority.</p>
          </div>
        </div>
      </div>
