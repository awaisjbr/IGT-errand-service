  ...
  return (
    <div className='pt-20 h-screen flex flex-col items-center justify-center gap-3'>
      ...
      <div className='flex flex-col items-center gap-5'>
        ...
        <p className='text-center w-[80%] text-slate-600 font-poppins'>Your message has been successfully submitted. We appreciate your interest in our errand services and will get back to you shortly.</p>
