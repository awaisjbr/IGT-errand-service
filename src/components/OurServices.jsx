      ...
      <div className="lg:w-[80%] mx-auto">
        ...
        <div className="overflow-x-scroll w-full flex gap-5 my-2">
            <div className="min-w-[350px] lg:min-w-[450px] xl:min-w-[550px] flex flex-col gap-1">
                <img className="border h-60 lg:h-72 xl:h-96 p-2 rounded-md hover:scale-95 transition-all duration-500" src="https://res.cloudinary.com/dpnjcu9gc/image/upload/v1739342033/courier_ozdcbg.jpg" alt="Personal-Image" />
            ...
            <div className="min-w-[350px] lg:min-w-[450px] xl:min-w-[550px] flex flex-col gap-1">
                <img className="border h-60 lg:h-72 xl:h-96 p-2 rounded-md hover:scale-95 transition-all duration-500" src="https://res.cloudinary.com/dpnjcu9gc/image/upload/v1739342044/medicine_pdvuxv.jpg" alt="Personal-Image" />
            ...
            <div className="min-w-[350px] lg:min-w-[450px] xl:min-w-[550px] flex flex-col gap-1">
                <img className="border h-60 lg:h-72 xl:h-96 p-2 rounded-md hover:scale-95 transition-all duration-500" src="https://res.cloudinary.com/dpnjcu9gc/image/upload/v1739342074/personal_slrwih.jpg" alt="Personal-Image" />
            ...
            <div className="min-w-[350px] lg:min-w-[450px] xl:min-w-[550px] flex flex-col gap-1">
                <img className="border h-60 lg:h-72 xl:h-96 p-2 rounded-md hover:scale-95 transition-all duration-500" src="https://res.cloudinary.com/dpnjcu9gc/image/upload/v1739342074/furniture_wy2cgj.jpg" alt="Personal-Image" />
            ...
            <div className="min-w-[350px] lg:min-w-[450px] xl:min-w-[550px] flex flex-col gap-1">
                <img className="border h-60 lg:h-72 xl:h-96 p-2 rounded-md hover:scale-95 transition-all duration-500" src="https://res.cloudinary.com/dpnjcu9gc/image/upload/v1739342054/gifts_uyq7oj.jpg" alt="Personal-Image" />
            ...
            <div className="min-w-[350px] lg:min-w-[450px] xl:min-w-[550px] flex flex-col gap-1">
                <img className="border h-60 lg:h-72 xl:h-96 p-2 rounded-md hover:scale-95 transition-all duration-500" src="https://res.cloudinary.com/dpnjcu9gc/image/upload/v1739342077/grocery_bp1k2d.jpg" alt="Personal-Image" />
            ...
            <div className="min-w-[350px] lg:min-w-[450px] xl:min-w-[550px] flex flex-col gap-1">
                <img className="border h-60 lg:h-72 xl:h-96 p-2 rounded-md hover:scale-95 transition-all duration-500" src="https://res.cloudinary.com/dpnjcu9gc/image/upload/v1739342096/fastfood_rmduiv.jpg" alt="Personal-Image" />
            ...
            <div className="min-w-[350px] lg:min-w-[450px] xl:min-w-[550px] flex flex-col gap-1">
                <img className="border h-60 lg:h-72 xl:h-96 p-2 rounded-md hover:scale-95 transition-all duration-500" src="https://res.cloudinary.com/dpnjcu9gc/image/upload/v1739342042/flowers_jk19kj.jpg" alt="Personal-Image" />
