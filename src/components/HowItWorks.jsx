...
const HowItWorks = () => {
  return (
    <div className="xl:h-screen lg:pt-24 px-2">
      ...
      <div className="px-1 lg:mt-10 xl:mt-20">
        <div className="flex flex-wrap gap-5 place-content-center">
          <div className="border p-3 w-80 rounded-md flex flex-col gap-3">
            <img className="h-52 w-full" src={findImg} alt="findImg" />
            {/* <p>[]</p> */}
            <h2 className="font-roboto text-lg font-semibold">1 - Find & Book</h2>
            <p className="text-sm font-poppins">Find and book your required errand within your comport zone. </p>
          </div>
          <div className="border p-3 w-80 rounded-md flex flex-col gap-3">
            <img className="h-52 w-full" src={paymentImg} alt="findImg" />
            {/* <p>[]</p> */}
          ...
          <div className="border p-3 w-80 rounded-md flex flex-col gap-3">
            <img className="h-52 w-full" src={hireImg} alt="findImg" />
            {/* <p>[]</p> */}
            <h2 className="font-roboto text-lg font-semibold">3 - Now hire us.</h2>
            <p className="text-sm font-poppins">Book your runner and provide us details and we will handle it with care.</p>
          </div>
          <div className="border p-3 w-80 rounded-md flex flex-col gap-3">
            <img className="h-52 w-full" src={deliverImg} alt="findImg" />
            {/* <p>[]</p> */}
            <h2 className="font-roboto text-lg font-semibold">4 - We will deliver it.</h2>
            <p className="text-sm font-poppins">Find your items delivered safley at your doorstep. </p>
          </div>
        </div>
      </div>
    </div>
